...
public class GeneticManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject trainedNeuralNetwork;
    ...
    private void RePopulate()
    {
        if (currentGeneration == 10)
        {
            ...
            SortPopulation();
            NNet betterNeuralNetwork = population[84];
            ManagingTrainedNeuralNetwork managingTrainedNeuralNetwork = trainedNeuralNetwork.GetComponent<ManagingTrainedNeuralNetwork>();

            if(managingTrainedNeuralNetwork == null)
            {
                Debug.Log("neural network trained not found");
            }

            managingTrainedNeuralNetwork.LoadTheTrainedData(betterNeuralNetwork);
